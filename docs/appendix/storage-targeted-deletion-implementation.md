...
TL;DR: the per-file changes, storage matrix and the `src/data/targetedDelete.js` helper API, cut from `docs/features/storage-management/targeted-deletion.md`. Reference only.
