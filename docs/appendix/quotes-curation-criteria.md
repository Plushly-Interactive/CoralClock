...
TL;DR: the seven curation criteria in full, with the reasoning for each, plus the table of rejected quotes and why they failed. Summary and checklist: `docs/features/enforcement-quotes-curation.md`.
